...
func (c *Conn) writeAuthHandshake() error {
	...
	// TODO:  i want to write text result-set message (100 rows returned out of 103,400 etc)
	//| mysql.CLIENT_SESSION_TRACK | mysql.CLIENT_DEPRECATE_EOF
